...
@section('title', 'Anggota | Edit Akun')
                    ...
                    <form action="{{ route('user-student.update', Auth::guard('student')->user()->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama" value="{{ Auth::guard('student')->user()->nama }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <a href="{{ route('user-student.index') }}"
                                    class="btn btn-secondary float-end ms-3">Kembali</a>
