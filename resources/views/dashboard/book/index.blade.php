                    ...
                    <table class="table table-bordered table-hover" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="19%">
                                    <a href="{{ route('book.show', $b->id) }}" class="btn btn-info" data-bs-toggle="tooltip" title="Lihat Detail Buku">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="{{ route('book.edit', $b->id) }}" class="btn btn-warning" data-bs-toggle="tooltip" title="Edit Buku">
